...
from atrag.config import settings as app_config
...
from atrag.db.models import Base

# Import the models module to automatically register all SQLAlchemy tables
# When you add new SQLAlchemy classes to atrag/db/models.py, they will be
# automatically discovered - no need to modify this file!
import atrag.db.models  # noqa: F401
