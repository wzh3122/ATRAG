...
from atrag.index.manager import document_index_manager
from atrag.objectstore.base import get_async_object_store
from atrag.schema import view_models
from atrag.schema.view_models import Chunk, DocumentList, DocumentPreview, VisionChunk
from atrag.service.marketplace_service import marketplace_service
from atrag.utils.pagination import (
    ListParams,
    PaginatedResponse,
    PaginationHelper,
    PaginationParams,
...
from atrag.utils.uncompress import SUPPORTED_COMPRESSED_EXTENSIONS
from atrag.utils.utils import calculate_file_hash, generate_vector_db_collection_name, utc_now
...
class DocumentService:
    ...
    async def upload_document(
        ...
        async def _upload_document_atomically(session):
            ...
            from atrag.db.models import random_id
    ...
    async def fetch_url_documents(self, user_id: str, collection_id: str, urls: list) -> view_models.FetchUrlResponse:
        ...
        from atrag.db.ops import async_db_ops as _db_ops
        from atrag.schema.view_models import WebReadRequest
